...
export default function AnalyticsPage() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      // Filter to only show completed research solutions
      const completedSolutions = (data.data || []).filter((log: RequestLogEntry) => 
        log.requestType === 'research' && log.status === 'completed'
      )
      
      setLogs(completedSolutions)
    } catch (err) {
  ...
  return (
    <div className="container mx-auto py-8 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">Generated Solutions</h1>
          <p className="text-muted-foreground">Solutions generated by users with account attribution</p>
        </div>
        <Button onClick={fetchLogs} variant="outline" size="sm">
          <RefreshCw className="h-4 w-4 mr-2" />
          Refresh
      ...
      <Card>
        <CardHeader>
          <CardTitle>Solutions Generated</CardTitle>
          <CardDescription>
            {logs.length} solutions generated by users
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Solution Generated</TableHead>
